...
The IR-bitcode fuzzer used to suppress the final masked FP round-trip shape by
default when the rounded value is added back to one of the masked operands. That
suppression was removed after llvm/llvm-project#198412 fixed this case for the
active LLVM HEAD and ROCm HEAD campaigns.
