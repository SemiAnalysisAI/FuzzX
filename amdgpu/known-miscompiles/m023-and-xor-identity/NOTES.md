...
| LLVM HEAD, commit `10756d32f96154f0889eda159ea9a26bc4188bda` | Reproduces: `O0=0x00000020`, `O2=0x00000029`. |
| ROCm HEAD, commit `9115c466b3577830455f70c4f492429bf6c64b25` | Reproduces: `O0=0x00000020`, `O2=0x00000029`. |

## Fuzzer Follow-Up

The IR-bitcode fuzzer now suppresses `(x & y) ^ x` and its operand-swapped
form by default. Set `FUZZX_ALLOW_M023_AND_XOR_IDENTITY=1` to re-enable this
shape.
