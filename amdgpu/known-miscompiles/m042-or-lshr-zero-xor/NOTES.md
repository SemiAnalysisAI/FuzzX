...
from llvm/llvm-project#198373. The original fuzzer program was a larger
bit-count/vector-reduction expression. The reduced testcase keeps the scalar
...
Without llvm/llvm-project#198373, `-O0` lowers the first smear through:
...
| LLVM HEAD, commit `0dd29960cd6102b37651cc3f58f872652099b83b`, with llvm/llvm-project#198373, llvm/llvm-project#196418, llvm/llvm-project#198412, and llvm/llvm-project#198419 applied locally | Passes: `O0=0xc1cfff8f`, `O2=0xc1cfff8f`. |
...
The fuzzer allows this shape with the current patched LLVM HEAD toolchain.
