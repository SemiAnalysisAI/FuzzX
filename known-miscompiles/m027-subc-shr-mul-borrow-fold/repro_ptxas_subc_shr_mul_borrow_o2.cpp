...
//   g++ -std=c++17 -O2 repro_ptxas_subc_shr_mul_borrow_o2.cpp \
//     -I/usr/local/cuda/include -L/usr/local/cuda/lib64/stubs -lcuda \
//     -o repro_ptxas_subc_shr_mul_borrow_o2
//
...
//
// Run:
//   ./repro_ptxas_subc_shr_mul_borrow_o2 [sm_XX]
//
// Optional:
//   PTXAS=/path/to/ptxas ./repro_ptxas_subc_shr_mul_borrow_o2 sm_103
//
// Correct PTX behavior for n = 32:
//   r1 = n >> 9              = 0
//   r1 = r1 * 3              = 0
//   r0 = 0xf0000000
//   sub.cc.u32 r2, r0, r1    has borrow-out 0
//   subc.u32 r3, r0, 31      = 0xf0000000 - 31 - 0 = 0xefffffe1
//
// ptxas -O0 stores 0xefffffe1. With affected ptxas versions, ptxas -O2 feeds
// an incorrect borrow into subc and stores 0xefffffe0. This reproduced on
...
constexpr uint32_t EXPECTED = 0xefffffe1u;
...
static std::vector<char> compile_ptx(const std::string& ptxas,
                                     ...
                                     const char* opt) {
    TempDir dir("/tmp/ptxas_subc_shr_mul_repro.XXXXXX");
