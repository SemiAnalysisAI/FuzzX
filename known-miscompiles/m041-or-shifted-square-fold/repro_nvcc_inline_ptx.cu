// CUDA inline-PTX variant of the m041-or-shifted-square-fold ptxas reproducer.
//
...
constexpr uint32_t kInput0 = 0x691a38a3u;
...
__global__ void repro_kernel(const uint32_t* in, uint32_t* out, uint32_t n, uint32_t x) {
    asm volatile(
        ...
        "mov.u32         r9, 33554432;\n\t"
        "mul.lo.u32      r0, r2, r9;\n\t"
        "and.b32         r1, 4278255360, r20;\n\t"
        "mad.lo.u32      r3, r0, 16, r1;\n\t"
        "sub.u32         r1, 620912, r3;\n\t"
        "mul.lo.u32      r19, 524288, r1;\n\t"
        "mul.lo.u32      r0, r19, r19;\n\t"
        "or.b32          r0, r0, 55244;\n\t"
        "\n\t"
        "exit:\n\t"
