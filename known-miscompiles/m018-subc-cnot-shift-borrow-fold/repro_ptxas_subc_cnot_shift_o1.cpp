...
//   g++ -std=c++17 -O2 repro_ptxas_subc_cnot_shift_o1.cpp \
//     -I/usr/local/cuda/include -L/usr/local/cuda/lib64/stubs -lcuda \
//     -o repro_ptxas_subc_cnot_shift_o1
//
...
//
// Run:
//   ./repro_ptxas_subc_cnot_shift_o1 [sm_XX]
//
// Optional:
//   PTXAS=/path/to/ptxas ./repro_ptxas_subc_cnot_shift_o1 sm_103
//
...
//     r5 = cnot.b32(32)        = 0
//     r9 = r5 << 12            = 0
//     r4 = sub.cc.u32 3285, r9 = 3285 with borrow-out 0
//     r9 = subc.u32 939, 433   = 939 - (433 + borrow-in 0) = 506
//
//   The correct output is therefore 0x000001fa.
//
// Observed bug with CUDA 13.0 ptxas V13.0.88 on sm_103 and with CUDA 13.2
// Update 1 ptxas V13.2.78 on sm_103:
//   -O0 stores 0x000001fa.
//   -O1, -O2, and -O3 store 0x000001f9.
//
// SASS root-cause summary:
//   At -O0, ptxas computes the cnot-derived zero and uses the real borrow-out
//   from `3285 - 0`, so subc subtracts no extra borrow. At -O1 and above,
//   ptxas folds the cnot/shift/sub.cc sequence but folds the subc as if the
//   borrow-in were 1, producing 505 instead of 506.
...
constexpr uint32_t EXPECTED = 0x000001fau;
...
static std::vector<char> compile_ptx(const std::string& ptxas,
                                     ...
                                     const char* opt) {
    TempDir dir("/tmp/ptxas_subc_cnot_repro.XXXXXX");
