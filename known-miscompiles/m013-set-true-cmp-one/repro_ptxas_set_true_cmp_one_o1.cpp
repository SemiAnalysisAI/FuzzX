...
//     -o repro_ptxas_set_true_cmp_one_o1
//
...
//
// Run:
//   ./repro_ptxas_set_true_cmp_one_o1 [sm_XX]
//
// Optional:
//   PTXAS=/path/to/ptxas ./repro_ptxas_set_true_cmp_one_o1 sm_103
//
...
static std::vector<char> compile_ptx(const std::string& ptxas,
                                     ...
                                     const char* opt) {
    TempDir dir("/tmp/ptxas_set_true_cmp_one_repro.XXXXXX");
