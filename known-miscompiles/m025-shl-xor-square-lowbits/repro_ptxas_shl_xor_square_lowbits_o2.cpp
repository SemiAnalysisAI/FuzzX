...
//   g++ -std=c++17 -O2 repro_ptxas_shl_xor_square_lowbits_o2.cpp \
//     -I/usr/local/cuda/include -L/usr/local/cuda/lib64/stubs -lcuda \
//     -o repro_ptxas_shl_xor_square_lowbits_o2
//
...
//
// Run:
//   ./repro_ptxas_shl_xor_square_lowbits_o2 [sm_XX]
//
// Optional:
//   PTXAS=/path/to/ptxas ./repro_ptxas_shl_xor_square_lowbits_o2 sm_103
//
...
static std::vector<char> compile_ptx(const std::string& ptxas,
                                     ...
                                     const char* opt) {
    TempDir dir("/tmp/ptxas_shl_xor_square_repro.XXXXXX");
