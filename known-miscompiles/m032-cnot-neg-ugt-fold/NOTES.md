...
```text
/tmp/ptx-fuzz-acyclic-multiblock-xlarge-imm65536-knownflags-nonot-sub-noboundary-200k/div-1778845876-18afbac66a83dc30
```
...
`repro_ptxas_cnot_neg_ugt_o2.cpp`. It embeds the reduced PTX, compiles it with
`ptxas -O0` and `ptxas -O2`, launches one thread through the CUDA Driver API,
