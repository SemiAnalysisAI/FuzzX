...
| `DIV_DISABLE_RICH_HELPER_CALLS` | Deterministic prologue coverage for multi-argument, multi-return, nested acyclic, explicit `.param` ABI, and mixed register/`.param` helper `.func` calls. |
