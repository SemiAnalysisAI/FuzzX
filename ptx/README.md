...
| `DIV_DISABLE_RICH_HELPER_CALLS` | Deterministic prologue coverage for multi-argument, multi-return, mixed-width return, 64-bit return, nested acyclic, explicit `.param` ABI, mixed register/`.param`, and predicate/select helper `.func` calls. |
