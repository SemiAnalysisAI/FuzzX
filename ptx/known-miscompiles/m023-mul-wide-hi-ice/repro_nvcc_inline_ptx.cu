// CUDA inline-PTX variant of the m023-mul-wide-hi-ice ptxas reproducer.
//
// Build this same CUDA source twice and ptxas -O2 is expected to fail during compilation:
//
