// CUDA inline-PTX variant of the m059-scalar16-pred-mulwide-fold ptxas reproducer.
//
...
__global__ void repro_kernel(uint32_t* out, const uint32_t* in, uint32_t n) {
    asm volatile(
        ...
        "setp.eq.u32 p0, 0, r3;\n\t"
        "cvt.u16.u32 h0, r2;\n\t"
        "cvt.u16.u32 h1, 38971;\n\t"
        "@!p0 mul.wide.u16 r0, h0, h1;\n\t"
        "cvta.to.global.u64 rd2, rd0;\n\t"
        "mul.wide.u32 rd4, r1, 16;\n\t"
        "add.s64 rd2, rd2, rd4;\n\t"
        "st.global.u32 [rd2 + 0], r0;\n\t"
        "st.global.u32 [rd2 + 4], 0;\n\t"
        "st.global.u32 [rd2 + 8], 0;\n\t"
        "st.global.u32 [rd2 + 12], 0;\n\t"
        "}\n"
        :
        : "l"(out), "l"(in), "r"(n)
        : "memory");
