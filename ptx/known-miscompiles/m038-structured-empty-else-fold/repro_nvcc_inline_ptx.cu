// CUDA inline-PTX variant of the m038-structured-empty-else-fold ptxas reproducer.
//
...
constexpr uint32_t kInput0 = 0x52f003a9u;
...
__global__ void repro_kernel(const uint32_t* in, uint32_t* out, uint32_t n, uint32_t x) {
    asm volatile(
        ...
        "shr.u32       r7, r7, 30;\n\t"
        "shr.u32       r8, 35274, 22;\n\t"
        "setp.ne.u32   p27, r10, 128;\n\t"
        "selp.b32      r17, 4294967295, r8, p27;\n\t"
        "setp.lt.u32   p28, r17, r7;\n\t"
        "@p28 bra   structured_if_3_then;\n\t"
        ...
        "bra             structured_if_4_then;\n\t"
        "structured_if_4_then:\n\t"
        "bra             structured_if_4_done;\n\t"
