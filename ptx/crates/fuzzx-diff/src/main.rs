...
//!                         direct PTX integer selp generation
//!   DIV_DISABLE_TYPED_SELP default: false; set 1/true/yes/on to suppress
//!                         direct PTX selp.u32 and selp.s32 generation
...
//!   DIV_DISABLE_SHARED_ATOMICS default: false; set 1/true/yes/on to suppress
//!                         per-thread shared-memory atomic roundtrips
//!   DIV_DISABLE_PREDICATED_SHARED_ATOMICS default: false; set 1/true/yes/on to suppress
//!                         predicated shared-memory atomic roundtrips
//!   DIV_DISABLE_SHARED_REDUCTIONS default: false; set 1/true/yes/on to suppress
//!                         per-thread shared-memory reduction roundtrips
//!   DIV_DISABLE_PREDICATED_SHARED_REDUCTIONS default: false; set 1/true/yes/on to suppress
//!                         predicated shared-memory reduction roundtrips
...
//!   DIV_DISABLE_VOLATILE_MEMORY default: false; set 1/true/yes/on to suppress
//!                         volatile global/shared memory loads and store/load roundtrips
//!   DIV_DISABLE_BIT_MEMORY default: false; set 1/true/yes/on to suppress
//!                         scalar/vector .b* memory load/store type suffixes
//!   DIV_DISABLE_MEMORY_FENCES default: false; set 1/true/yes/on to suppress
//!                         membar/fence memory-ordering instructions
//!   DIV_DISABLE_WARP_BARRIERS default: false; set 1/true/yes/on to suppress
//!                         prologue bar.warp.sync full-warp barriers
//!   DIV_DISABLE_WARP_COLLECTIVES default: false; set 1/true/yes/on to suppress
//!                         prologue full-mask warp vote/match/shuffle/redux instructions
//!   DIV_DISABLE_CTA_BARRIERS default: false; set 1/true/yes/on to suppress
//!                         prologue CTA-level bar.sync/barrier.sync instructions
//!   DIV_DISABLE_CTA_BARRIER_REDUCTIONS default: false; set 1/true/yes/on to suppress
//!                         prologue bar.red/barrier.red reduction instructions
//!   DIV_DISABLE_PREFETCH default: false; set 1/true/yes/on to suppress
//!                         global/uniform cache-prefetch hints
//!   DIV_DISABLE_CACHE_POLICY_HELPERS default: false; set 1/true/yes/on to suppress
//!                         cache-policy creation, applypriority, and cache-hint loads
//!   DIV_DISABLE_HELPER_CALLS default: false; set 1/true/yes/on to suppress
//!                         deterministic prologue calls to a generated leaf .func
//!   DIV_DISABLE_RICH_HELPER_CALLS default: false; set 1/true/yes/on to suppress
//!                         deterministic multi-arg and multi-return helper calls
...
//!                         deterministic scalar f16 set/setp and selp.b16 prologue coverage
//!   DIV_DISABLE_F16_CVT default: false; set 1/true/yes/on to suppress
//!                         deterministic f16/f16x2 conversion-chain prologue coverage
//!   DIV_DISABLE_BF16_TF32_CVT default: false; set 1/true/yes/on to suppress
//!                         deterministic bf16/bf16x2/tf32 conversion prologue coverage
...
//!   DIV_DISABLE_BRANCH_TABLES default: false; set 1/true/yes/on to suppress
//!                         prologue brx.idx branch-table instructions
...
//!                         PTX not/cnot/popc/clz/brev.b64 and neg/abs.s64 generation
//!   DIV_DISABLE_SIGNED_WIDE_UNARY default: false; set 1/true/yes/on to suppress
//!                         PTX neg.s64 and abs.s64 generation
...
//!   DIV_DISABLE_CVT_PACK default: false; set 1/true/yes/on to suppress
//!                         deterministic cvt.pack prologue coverage
...
//!                         PTX slct.s32.* generation
//!   DIV_DISABLE_F32_SLCT  default: false; set 1/true/yes/on to suppress
//!                         PTX slct forms with f32 result or selector
//!   DIV_DISABLE_WIDE_SLCT default: false; set 1/true/yes/on to suppress
//!                         PTX slct forms with u64/s64/b64 result
//!   DIV_DISABLE_F64_SLCT  default: false; set 1/true/yes/on to suppress
//!                         PTX slct.f64.* generation
//!   DIV_DISABLE_VIDEO     default: false; set 1/true/yes/on to suppress
//!                         PTX video instruction generation
//!   DIV_DISABLE_SIGNED_VIDEO default: false; set 1/true/yes/on to suppress
//!                         signed/mixed s32 video instruction suffixes
//!   DIV_DISABLE_VIDEO_SAT default: false; set 1/true/yes/on to suppress
//!                         PTX video .sat instruction forms
//!   DIV_DISABLE_VSUB4     default: false; set 1/true/yes/on to suppress
//!                         PTX vsub4.* generation
...
struct Args {
    ...
    #[arg(long)]
    disable_uniform_global_loads: bool,
    #[arg(long)]
    disable_global_store_roundtrips: bool,
    #[arg(long)]
    disable_global_atomics: bool,
    #[arg(long)]
    disable_global_atomic_dec: bool,
    #[arg(long)]
    disable_global_atomic_xor: bool,
    #[arg(long)]
    disable_predicated_global_atomics: bool,
    #[arg(long)]
    disable_global_reductions: bool,
    #[arg(long)]
    disable_predicated_global_reductions: bool,
    #[arg(long)]
    disable_generic_memory: bool,
    #[arg(long)]
    disable_predicated_generic_memory: bool,
    #[arg(long)]
    ...
    #[arg(long)]
    disable_volatile_memory: bool,
    #[arg(long)]
    disable_bit_memory: bool,
    #[arg(long)]
    disable_memory_fences: bool,
    #[arg(long)]
    disable_warp_barriers: bool,
    #[arg(long)]
    disable_warp_collectives: bool,
    #[arg(long)]
    disable_cta_barriers: bool,
    #[arg(long)]
    disable_cta_barrier_reductions: bool,
    #[arg(long)]
    disable_prefetch: bool,
    #[arg(long)]
    disable_cache_policy_helpers: bool,
    #[arg(long)]
    disable_helper_calls: bool,
    #[arg(long)]
    disable_rich_helper_calls: bool,
    #[arg(long)]
    ...
    #[arg(long)]
    disable_f16_cvt: bool,
    #[arg(long)]
    disable_bf16_tf32_cvt: bool,
    #[arg(long)]
    ...
    #[arg(long)]
    disable_signed_wide_unary: bool,
    #[arg(long)]
    ...
    #[arg(long)]
    disable_f32_slct: bool,
    #[arg(long)]
    disable_wide_slct: bool,
    #[arg(long)]
    disable_f64_slct: bool,
    #[arg(long)]
    disable_video: bool,
    #[arg(long)]
    disable_signed_video: bool,
    #[arg(long)]
    disable_video_sat: bool,
    #[arg(long)]
    disable_vsub4: bool,
}
...
impl Args {
    fn apply_env_overrides(self) {
        ...
        set_bool!(self.disable_typed_selp, "DIV_DISABLE_TYPED_SELP");
        ...
        set_bool!(
            self.disable_uniform_global_loads,
            "DIV_DISABLE_UNIFORM_GLOBAL_LOADS"
        );
        set_bool!(
            self.disable_global_store_roundtrips,
            "DIV_DISABLE_GLOBAL_STORE_ROUNDTRIPS"
        );
        set_bool!(self.disable_global_atomics, "DIV_DISABLE_GLOBAL_ATOMICS");
        set_bool!(
            self.disable_global_atomic_dec,
            "DIV_DISABLE_GLOBAL_ATOMIC_DEC"
        );
        set_bool!(
            self.disable_global_atomic_xor,
            "DIV_DISABLE_GLOBAL_ATOMIC_XOR"
        );
        set_bool!(
            self.disable_predicated_global_atomics,
            "DIV_DISABLE_PREDICATED_GLOBAL_ATOMICS"
        );
        set_bool!(
            self.disable_global_reductions,
            "DIV_DISABLE_GLOBAL_REDUCTIONS"
        );
        set_bool!(
            self.disable_predicated_global_reductions,
            "DIV_DISABLE_PREDICATED_GLOBAL_REDUCTIONS"
        );
        set_bool!(self.disable_generic_memory, "DIV_DISABLE_GENERIC_MEMORY");
        set_bool!(
            self.disable_predicated_generic_memory,
            "DIV_DISABLE_PREDICATED_GENERIC_MEMORY"
        );
        ...
        set_bool!(
            self.disable_shared_reductions,
            "DIV_DISABLE_SHARED_REDUCTIONS"
        );
        set_bool!(
            self.disable_predicated_shared_reductions,
            "DIV_DISABLE_PREDICATED_SHARED_REDUCTIONS"
        );
        set_bool!(
        ...
        set_bool!(self.disable_volatile_memory, "DIV_DISABLE_VOLATILE_MEMORY");
        set_bool!(self.disable_bit_memory, "DIV_DISABLE_BIT_MEMORY");
        set_bool!(self.disable_memory_fences, "DIV_DISABLE_MEMORY_FENCES");
        set_bool!(self.disable_warp_barriers, "DIV_DISABLE_WARP_BARRIERS");
        set_bool!(
            self.disable_warp_collectives,
            "DIV_DISABLE_WARP_COLLECTIVES"
        );
        set_bool!(self.disable_cta_barriers, "DIV_DISABLE_CTA_BARRIERS");
        set_bool!(
            self.disable_cta_barrier_reductions,
            "DIV_DISABLE_CTA_BARRIER_REDUCTIONS"
        );
        set_bool!(self.disable_prefetch, "DIV_DISABLE_PREFETCH");
        set_bool!(
            self.disable_cache_policy_helpers,
            "DIV_DISABLE_CACHE_POLICY_HELPERS"
        );
        set_bool!(self.disable_helper_calls, "DIV_DISABLE_HELPER_CALLS");
        set_bool!(
            self.disable_rich_helper_calls,
            "DIV_DISABLE_RICH_HELPER_CALLS"
        );
        ...
        set_bool!(self.disable_f16_cvt, "DIV_DISABLE_F16_CVT");
        set_bool!(self.disable_bf16_tf32_cvt, "DIV_DISABLE_BF16_TF32_CVT");
        ...
        set_bool!(self.disable_branch_tables, "DIV_DISABLE_BRANCH_TABLES");
        ...
        set_bool!(
            self.disable_signed_wide_unary,
            "DIV_DISABLE_SIGNED_WIDE_UNARY"
        );
        set_bool!(
        ...
        set_bool!(self.disable_cvt_pack, "DIV_DISABLE_CVT_PACK");
        ...
        set_bool!(self.disable_f32_slct, "DIV_DISABLE_F32_SLCT");
        set_bool!(self.disable_wide_slct, "DIV_DISABLE_WIDE_SLCT");
        set_bool!(self.disable_f64_slct, "DIV_DISABLE_F64_SLCT");
        set_bool!(self.disable_video, "DIV_DISABLE_VIDEO");
        set_bool!(self.disable_signed_video, "DIV_DISABLE_SIGNED_VIDEO");
        set_bool!(self.disable_video_sat, "DIV_DISABLE_VIDEO_SAT");
...
impl Config {
    fn from_env() -> Result<Self> {
        ...
        let disable_typed_selp = env_bool("DIV_DISABLE_TYPED_SELP")?.unwrap_or(false);
        ...
        let disable_uniform_global_loads =
            env_bool("DIV_DISABLE_UNIFORM_GLOBAL_LOADS")?.unwrap_or(false);
        let disable_global_store_roundtrips =
            env_bool("DIV_DISABLE_GLOBAL_STORE_ROUNDTRIPS")?.unwrap_or(false);
        let disable_global_atomics = env_bool("DIV_DISABLE_GLOBAL_ATOMICS")?.unwrap_or(false);
        let disable_global_atomic_dec = env_bool("DIV_DISABLE_GLOBAL_ATOMIC_DEC")?.unwrap_or(false);
        let disable_global_atomic_xor = env_bool("DIV_DISABLE_GLOBAL_ATOMIC_XOR")?.unwrap_or(false);
        let disable_predicated_global_atomics =
            env_bool("DIV_DISABLE_PREDICATED_GLOBAL_ATOMICS")?.unwrap_or(false);
        let disable_global_reductions = env_bool("DIV_DISABLE_GLOBAL_REDUCTIONS")?.unwrap_or(false);
        let disable_predicated_global_reductions =
            env_bool("DIV_DISABLE_PREDICATED_GLOBAL_REDUCTIONS")?.unwrap_or(false);
        let disable_generic_memory = env_bool("DIV_DISABLE_GENERIC_MEMORY")?.unwrap_or(false);
        let disable_predicated_generic_memory =
            env_bool("DIV_DISABLE_PREDICATED_GENERIC_MEMORY")?.unwrap_or(false);
        ...
        let disable_predicated_shared_reductions =
            env_bool("DIV_DISABLE_PREDICATED_SHARED_REDUCTIONS")?.unwrap_or(false);
        ...
        let disable_volatile_memory = env_bool("DIV_DISABLE_VOLATILE_MEMORY")?.unwrap_or(false);
        let disable_bit_memory = env_bool("DIV_DISABLE_BIT_MEMORY")?.unwrap_or(false);
        let disable_memory_fences = env_bool("DIV_DISABLE_MEMORY_FENCES")?.unwrap_or(false);
        let disable_warp_barriers = env_bool("DIV_DISABLE_WARP_BARRIERS")?.unwrap_or(false);
        let disable_warp_collectives = env_bool("DIV_DISABLE_WARP_COLLECTIVES")?.unwrap_or(false);
        let disable_cta_barriers = env_bool("DIV_DISABLE_CTA_BARRIERS")?.unwrap_or(false);
        let disable_cta_barrier_reductions =
            env_bool("DIV_DISABLE_CTA_BARRIER_REDUCTIONS")?.unwrap_or(false);
        let disable_prefetch = env_bool("DIV_DISABLE_PREFETCH")?.unwrap_or(false);
        let disable_cache_policy_helpers =
            env_bool("DIV_DISABLE_CACHE_POLICY_HELPERS")?.unwrap_or(false);
        let disable_helper_calls = env_bool("DIV_DISABLE_HELPER_CALLS")?.unwrap_or(false);
        let disable_rich_helper_calls = env_bool("DIV_DISABLE_RICH_HELPER_CALLS")?.unwrap_or(false);
        ...
        let disable_f16_cvt = env_bool("DIV_DISABLE_F16_CVT")?.unwrap_or(false);
        let disable_bf16_tf32_cvt = env_bool("DIV_DISABLE_BF16_TF32_CVT")?.unwrap_or(false);
        ...
        let disable_branch_tables = env_bool("DIV_DISABLE_BRANCH_TABLES")?.unwrap_or(false);
        ...
        let disable_signed_wide_unary = env_bool("DIV_DISABLE_SIGNED_WIDE_UNARY")?.unwrap_or(false);
        ...
        let disable_cvt_pack = env_bool("DIV_DISABLE_CVT_PACK")?.unwrap_or(false);
        ...
        let disable_f32_slct = env_bool("DIV_DISABLE_F32_SLCT")?.unwrap_or(false);
        let disable_wide_slct = env_bool("DIV_DISABLE_WIDE_SLCT")?.unwrap_or(false);
        let disable_f64_slct = env_bool("DIV_DISABLE_F64_SLCT")?.unwrap_or(false);
        let disable_video = env_bool("DIV_DISABLE_VIDEO")?.unwrap_or(false);
        let disable_signed_video = env_bool("DIV_DISABLE_SIGNED_VIDEO")?.unwrap_or(false);
        let disable_video_sat = env_bool("DIV_DISABLE_VIDEO_SAT")?.unwrap_or(false);
        ...
        let mut gen_config = GenConfig {
            ...
            emit_typed_selp: !disable_typed_selp && !disable_selp,
            ...
            emit_uniform_global_loads: !disable_uniform_global_loads && !disable_global_loads,
            emit_global_store_roundtrips: !disable_global_store_roundtrips
                && !disable_mul_wide
                && !disable_wide_int,
            emit_global_atomics: !disable_global_atomics
                && !disable_global_store_roundtrips
                && !disable_mul_wide
                && !disable_wide_int,
            emit_global_atomic_dec: !disable_global_atomic_dec && !disable_global_atomics,
            emit_global_atomic_xor: !disable_global_atomic_xor && !disable_global_atomics,
            emit_predicated_global_atomics: !disable_predicated_global_atomics
                && !disable_global_atomics
                && !disable_global_store_roundtrips
                && !disable_mul_wide
                && !disable_wide_int
                && !disable_predicated_memory,
            emit_global_reductions: !disable_global_reductions
                && !disable_global_store_roundtrips
                && !disable_mul_wide
                && !disable_wide_int,
            emit_predicated_global_reductions: !disable_predicated_global_reductions
                && !disable_global_reductions
                && !disable_global_store_roundtrips
                && !disable_mul_wide
                && !disable_wide_int
                && !disable_predicated_memory,
            emit_generic_memory: !disable_generic_memory
                && !disable_global_store_roundtrips
                && !disable_mul_wide
                && !disable_wide_int,
            emit_predicated_generic_memory: !disable_predicated_generic_memory
                && !disable_generic_memory
                && !disable_global_store_roundtrips
                && !disable_mul_wide
                && !disable_wide_int
                && !disable_predicated_memory,
            ...
            emit_shared_atomics: !disable_shared_atomics
                ...
                && !disable_mul_wide
                && !disable_wide_int,
            emit_predicated_shared_atomics: !disable_predicated_shared_atomics
                && !disable_shared_atomics
                && !disable_shared_memory
                && !disable_mul_wide
                && !disable_wide_int
                && !disable_predicated_memory,
            emit_shared_reductions: !disable_shared_reductions
                && !disable_shared_memory
                && !disable_mul_wide
                && !disable_wide_int,
            emit_predicated_shared_reductions: !disable_predicated_shared_reductions
                && !disable_shared_reductions
                && !disable_shared_memory
                && !disable_mul_wide
                && !disable_wide_int
                && !disable_predicated_memory,
            ...
            emit_volatile_memory: !disable_volatile_memory,
            emit_bit_memory: !disable_bit_memory,
            emit_memory_fences: !disable_memory_fences,
            emit_warp_barriers: !disable_warp_barriers,
            emit_warp_collectives: !disable_warp_collectives,
            emit_cta_barriers: !disable_cta_barriers,
            emit_cta_barrier_reductions: !disable_cta_barrier_reductions,
            emit_prefetch: !disable_prefetch,
            emit_cache_policy_helpers: !disable_cache_policy_helpers,
            emit_helper_calls: !disable_helper_calls,
            emit_rich_helper_calls: !disable_rich_helper_calls,
            ...
            emit_f16_cvt: !disable_f16_cvt,
            emit_bf16_tf32_cvt: !disable_bf16_tf32_cvt,
            ...
            emit_branch_tables: !disable_branch_tables,
            ...
            emit_signed_wide_unary: !disable_signed_wide_unary && !disable_wide_unary,
            ...
            emit_predicated_wide_cvt: !disable_predicated_wide_cvt
                && !disable_wide_cvt
                && !disable_predicated_cvt,
            emit_cvt_pack: !disable_cvt_pack,
            ...
            emit_f32_slct: !disable_f32_slct && !disable_slct,
            emit_wide_slct: !disable_wide_slct && !disable_slct,
            emit_f64_slct: !disable_f64_slct && !disable_slct,
            emit_video: !disable_video,
            emit_signed_video: !disable_signed_video && !disable_video,
            emit_video_sat: !disable_video_sat && !disable_video,
            emit_vsub4: !disable_vsub4 && !disable_video,
            ..GenConfig::default()
        };
...
fn main() -> Result<()> {
    ...
    eprintln!(
        ...
        cfg.gen_config.emit_typed_selp,
        ...
        cfg.gen_config.emit_uniform_global_loads,
        cfg.gen_config.emit_global_store_roundtrips,
        cfg.gen_config.emit_global_atomics,
        cfg.gen_config.emit_global_atomic_dec,
        cfg.gen_config.emit_global_atomic_xor,
        cfg.gen_config.emit_predicated_global_atomics,
        cfg.gen_config.emit_global_reductions,
        cfg.gen_config.emit_predicated_global_reductions,
        cfg.gen_config.emit_generic_memory,
        cfg.gen_config.emit_predicated_generic_memory,
        cfg.gen_config.emit_const_memory,
        cfg.gen_config.emit_local_memory,
        cfg.gen_config.emit_shared_memory,
        cfg.gen_config.emit_shared_atomics,
        cfg.gen_config.emit_predicated_shared_atomics,
        cfg.gen_config.emit_shared_reductions,
        cfg.gen_config.emit_predicated_shared_reductions,
        ...
        cfg.gen_config.emit_volatile_memory,
        cfg.gen_config.emit_bit_memory,
        cfg.gen_config.emit_memory_fences,
        cfg.gen_config.emit_warp_barriers,
        cfg.gen_config.emit_warp_collectives,
        cfg.gen_config.emit_cta_barriers,
        cfg.gen_config.emit_cta_barrier_reductions,
        cfg.gen_config.emit_prefetch,
        cfg.gen_config.emit_cache_policy_helpers,
        cfg.gen_config.emit_helper_calls,
        cfg.gen_config.emit_rich_helper_calls,
        ...
        cfg.gen_config.emit_f16_arith,
        cfg.gen_config.emit_f16_compare,
        cfg.gen_config.emit_f16_cvt,
        cfg.gen_config.emit_bf16_tf32_cvt,
        ...
        cfg.gen_config.emit_branch_tables,
        ...
        cfg.gen_config.emit_signed_wide_unary,
        ...
        cfg.gen_config.emit_f32_slct,
        cfg.gen_config.emit_wide_slct,
        cfg.gen_config.emit_f64_slct,
        cfg.gen_config.emit_video,
        cfg.gen_config.emit_signed_video,
        cfg.gen_config.emit_video_sat,
