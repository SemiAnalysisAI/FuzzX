...
{{
    ...
    mov.b16 %h2, 0;
    @%p0 cvt.f32.f16 %f0, %h0;
    @%p0 cvt.rn.f16.f32 %h2, %f0;
    cvt.u32.u16 %r2, %h2;
    add.u32 %r0, %r0, %r2;
    mov.b16 %h3, 0;
    @%p0 cvt.f64.f16 %fd0, %h1;
    @%p0 cvt.rn.f16.f64 %h3, %fd0;
    cvt.u32.u16 %r2, %h3;
    add.u32 %r0, %r0, %r2;
    mov.u32 %r2, 0;
    @%p0 cvt.rzi.u32.f16 %r2, %h2;
    add.u32 %r0, %r0, %r2;
    mov.u32 %r2, 0;
    @%p0 cvt.rzi.s32.f16 %r2, %h3;
    add.u32 %r0, %r0, %r2;
    mov.u32 %r2, 5;
    mov.b16 %h2, 0;
    @%p0 cvt.rn.f16.u32 %h2, %r2;
    cvt.u32.u16 %r2, %h2;
    add.u32 %r0, %r0, %r2;
    mov.s32 %r2, -5;
    mov.b16 %h3, 0;
    @%p0 cvt.rn.f16.s32 %h3, %r2;
    cvt.u32.u16 %r2, %h3;
    add.u32 %r0, %r0, %r2;
    @%p0 cvt.rn.f16x2.f32 %r2, %f0, %f1;
    add.u32 %r0, %r0, %r2;
    and.b32 %r2, %r0, 1023;
    add.u32 %r2, %r2, 0x3c00;
    cvt.u16.u32 %h0, %r2;
    and.b32 %r2, %r0, 511;
    add.u32 %r2, %r2, 0x4000;
    cvt.u16.u32 %h1, %r2;
    mov.b32 %r3, {{%h0, %h1}};
    and.b32 %r2, %r1, 1023;
    add.u32 %r2, %r2, 0x3c00;
    ...
    cvt.u16.u32 %h1, %r2;
    mov.b32 %r4, {{%h0, %h1}};
    set.eq.u32.f16x2 %r2, %r3, %r4;
    add.u32 %r0, %r0, %r2;
    set.nan.u32.f16x2 %r2, %r3, %r4;
    add.u32 %r0, %r0, %r2;
    setp.lt.f16x2 %p2, %r3, %r4;
    setp.ge.and.f16x2 %p3, %r4, %r3, %p2;
    selp.u32 %r2, 1, 0, %p2;
    add.u32 %r0, %r0, %r2;
    selp.u32 %r2, 2, 0, %p3;
    add.u32 %r0, %r0, %r2;
    selp.b32 %r5, %r3, %r4, %p2;
    add.u32 %r0, %r0, %r5;
    @%p3 selp.b32 %r5, %r4, %r3, %p2;
    add.u32 %r0, %r0, %r5;
    mov.b32 %r5, %r3;
    @%p0 fma.rn.f16x2 %r5, %r3, %r4, %r3;
    add.u32 %r0, %r0, %r5;
...
{{
    ...
    add.u32 %r6, %r6, %r7;
    st.param.b32 [fuzzx_param_a], %r6;
    call.uni (%r7), fuzzx_mixed_param_helper, (%r3, fuzzx_param_a, %r4);
    add.u32 %r6, %r6, %r7;
    cvt.u64.u32 %rd1, %r6;
    shl.b64 %rd1, %rd1, 32;
    cvt.u64.u32 %rd2, %r7;
    or.b64 %rd1, %rd1, %rd2;
    cvt.u64.u32 %rd2, %r0;
    call.uni (%rd3), fuzzx_wide_helper, (%rd1, %rd2, %r5);
    cvt.u32.u64 %r7, %rd3;
    shr.u64 %rd4, %rd3, 32;
    cvt.u32.u64 %r5, %rd4;
    xor.b32 %r7, %r7, %r5;
    ...
    add.u32 %r6, %r6, %r7;
    call.uni (%r5, %rd4), fuzzx_mixed_return_helper, (%r6, %rd3, %r7);
    cvt.u32.u64 %r7, %rd4;
    shr.u64 %rd2, %rd4, 32;
    cvt.u32.u64 %r4, %rd2;
    xor.b32 %r7, %r7, %r4;
    ...
    call.uni (%f2), fuzzx_f32_bit_helper, (%f0, %f1, %r6);
    mov.b32 %r7, %f2;
    add.u32 %r6, %r6, %r7;
    mov.b64 %fd0, 0d3ff0000000000000;
    mov.b64 %fd1, 0d4000000000000000;
    call.uni (%fd2), fuzzx_f64_bit_helper, (%fd0, %fd1, %r6);
    mov.b64 %rd4, %fd2;
    cvt.u32.u64 %r7, %rd4;
    shr.u64 %rd2, %rd4, 32;
    cvt.u32.u64 %r4, %rd2;
